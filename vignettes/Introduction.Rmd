...
## Running the model
To run the model the [R/run_model.R](https://github.com/IsaacStopard/RSVsim/blob/master/R/run_model.R) function is used. Cohort aging is used to age the population at each time the smallest age group has completed the time within that age group. If no initial conditions are given it is assumed there is one percent prevalence in the primary infection compartment and everyone else is susceptible to primary infection. All new borns are assumed to be susceptible to their primary infection. Below we plot the simulated number of people that are susceptible and infected, with the line type indicating whether the infection is primary or secondary.
