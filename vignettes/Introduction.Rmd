...
The incidence and detected incidence. To calculate the detected incidence age-specific detection probabilities are used, and in the default parameters we assume no one over the age of 2 years old is tested.
