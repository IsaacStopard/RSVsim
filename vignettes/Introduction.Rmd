...
```{r contact_matrix, dependson="setup"}
...
```{r parameters, dependson="contact_matrix"}
...
Below, we plot the simulated number of people that are susceptible and infected, with the line type indicating whether the infection is primary or secondary.

```{r, model_plot, dependson="model_run"}
ggplot(data = out) +
...
```{r inc_plot, dependson="model_run"}
ggplot(data = out, 
