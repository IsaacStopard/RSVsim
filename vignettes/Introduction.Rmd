...
## Default parameters
To obtain a list of the default parameters to run the model use the [R/get_parameters.R](https://github.com/IsaacStopard/RSVsim/blob/master/R/get_parameters.R) function. The parameters can be changed by using the overrides argument; for example we override b0 (the transmission rate coefficient) with a value of 0.15.
