...
## Contact matrix
Contact matrices can be obtained within the package using the POLYMOD data (<https://doi.org/10.1371/journal.pmed.0050074>). To do so, the socialmixr () package is used to obtain the contact matrix for the age groupings of the given age limits that are integers. The contact matrix is calculated such that the total contacts in the population (assuming population data from ) are symmetric.
