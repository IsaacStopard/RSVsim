...
overrides <- list("b0" = 0.08, "b1" = 0, "phi" = 0,
                  "R0" = contact_population_list$rel_sizes * 27536874 * 0.1,
                  "Sp0" = contact_population_list$rel_sizes * 27536874 * (1 - 0.1 - 0.01),
                  "Ep0" = contact_population_list$rel_sizes * 27536874 * 0,
                  "Ip0" = contact_population_list$rel_sizes * 27536874 * 0.01,
...
prior_fun <- function(n_prior_attempts){
  ...
  x5 <- lapply(1:n_prior_attempts,
               function(i){
                 (1 - 0.01 - x[i,4]) * rel_sizes * total_population
               }
               )
