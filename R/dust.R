...
RSV_ODE <- structure(
  ...
  parameters = data.frame(
    name = c("nAges", "b0", "b1", "phi", "delta", "gamma_s", "gamma_p", "nu", "omega_vect", "prop_detected_vect", "sigma_vect", "alpha_vect", "mixing", "Sp0", "Ep0", "Ip0", "Ss0", "Es0", "Is0", "R0", "Incidence0", "DetIncidence0"),
